...
class MoviesViewModelTest {
    ...
    @Test
    fun testToggleBookmarkPessimisticUpdate() =
        runTest {
            val testItem =
                Item(
                    id = 99,
    ...
    @Test
    fun `SelectLanguage should update language and trigger re-fetch`() =
        runTest {
    ...
    @Test
    fun `SelectSortOrder should update sort order and trigger re-fetch`() =
        runTest {
            // Clear initial invocation
            io.mockk.clearMocks(mockGetMoviesUseCase, answers = false)
